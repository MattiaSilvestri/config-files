...
echo '${goto 0}''${font mono:size=13}'$TOPLINE | sed 's/Su/${color #ac6365}Su${color}/g'
echo '${goto 0}''${font mono:bold:size=13}''${color #57647c}'$OVER '${color cc6666}'$TODAY'${color 57647c}'$REST

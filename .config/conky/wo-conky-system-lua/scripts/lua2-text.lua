...
--DCE142
    text_settings={
		...
		{text=conky_parse("${top name 1}"),x=20,y=396,colour={{0,0X4cf886,1}},font_size=16,},  
		{text=conky_parse("${top name 2}"),x=20,y=414,colour={{0,0X4cf886,1}},font_size=16,},
		{text=conky_parse("${top name 3}"),x=20,y=432,colour={{0,0X4cf886,1}},font_size=16,},
		{text=conky_parse("${top name 4}"),x=20,y=450,colour={{0,0X4cf886,1}},font_size=16,},
		{text=conky_parse("${top name 5}"),x=20,y=468,colour={{0,0X4cf886,1}},font_size=16,},
		{text=conky_parse("${top name 6}"),x=20,y=486,colour={{0,0X4cf886,1}},font_size=16,},
        

		{text=conky_parse("${top cpu 1}%"),x=228,y=396,h_align="r",colour={{0,0X4cf886,1}},font_size=16,},
		{text=conky_parse("${top cpu 2}%"),x=228,y=414,h_align="r",colour={{0,0X4cf886,1}},font_size=16,},
		{text=conky_parse("${top cpu 3}%"),x=228,y=432,h_align="r",colour={{0,0X4cf886,1}},font_size=16,},
		{text=conky_parse("${top cpu 4}%"),x=228,y=450,h_align="r",colour={{0,0X4cf886,1}},font_size=16,},
		{text=conky_parse("${top cpu 5}%"),x=228,y=468,h_align="r",colour={{0,0X4cf886,1}},font_size=16,},
		{text=conky_parse("${top cpu 6}%"),x=228,y=486,h_align="r",colour={{0,0X4cf886,1}},font_size=16,},

		--{text=conky_parse("${top cpu 1}%"),x=228,y=396,h_align="r",colour={{0,0X42E147,1}},font_size=16,},
		--{text=conky_parse("${top cpu 2}%"),x=228,y=414,h_align="r",colour={{0,0X42E147,0.85}},font_size=16,},
		--{text=conky_parse("${top cpu 3}%"),x=228,y=432,h_align="r",colour={{0,0X42E147,0.70}},font_size=16,},
		--{text=conky_parse("${top cpu 4}%"),x=228,y=450,h_align="r",colour={{0,0X42E147,0.55}},font_size=16,},
		--{text=conky_parse("${top cpu 5}%"),x=228,y=468,h_align="r",colour={{0,0X42E147,0.40}},font_size=16,},
		--{text=conky_parse("${top cpu 6}%"),x=228,y=486,h_align="r",colour={{0,0X42E147,0.25}},font_size=16,},

...
return {
  ...
  opts = {
    ...
    features = {
      ...
      codelens_enabled = true, -- enable/disable codelens refresh on start
    ...
    handlers = {
      ...
      pylsp = function(_, opts) require("lspconfig").pylsp.setup(opts) end, -- or a custom handler function can be passed
    },

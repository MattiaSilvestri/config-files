...
(let* ((bg "#131313")
      ...
      (dank-blue "#95b1f2")         ; Blue-green
      (dank-magenta "#314576")      ; Teal-magenta
      (dank-cyan "#aec6ff")         ; Bright cyan
      (dank-cyan-bright "#baceff") ; Brightest cyan
      (dank-cyan-dark "#c6d7ff")   ; Dark cyan
      (dank-teal "#dae5ff")        ; Dark teal
      (dank-fg "#eff4ff")           ; Light foreground
      (dank-gray "#999ca5")         ; Gray
      (dank-white "#f8faff")       ; White

      ;; Map success colors to green
      (success "#7fff92")
      (on-success "#402843")
      (success-container "#583e5a")
      (on-success-container "#fcd7fb")
      ...
      (tertiary-fixed-dim "#dfbbde")
      (on-primary-fixed "#001a43")
      (on-primary-fixed-variant "#14448f")
      (on-secondary-fixed "#141b2c")
      (on-secondary-fixed-variant "#3f4759")
      (on-tertiary-fixed "#2a132d")
      (on-tertiary-fixed-variant "#583e5a")

      ;; Map inverse colors
      (inverse-on-surface "#303030")
      (inverse-primary "#335ca8")

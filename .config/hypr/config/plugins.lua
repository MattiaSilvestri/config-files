...
hl.plugin("hy3", function()
    group_inset = 0,
end)

-- TODO: manual review (unknown dispatcher: hy3:movewindow)
-- hl.bind("Super+Shift + Left", hl.dsp.hy3:movewindow("l"))

-- [hidden]

-- TODO: manual review (unknown dispatcher: hy3:movewindow)
-- hl.bind("Super+Shift + Right", hl.dsp.hy3:movewindow("r"))

-- [hidden]

-- TODO: manual review (unknown dispatcher: hy3:movewindow)
-- hl.bind("Super+Shift + Up", hl.dsp.hy3:movewindow("u"))

-- [hidden]

-- TODO: manual review (unknown dispatcher: hy3:movewindow)
-- hl.bind("Super+Shift + Down", hl.dsp.hy3:movewindow("d"))

-- [hidden]

-- TODO: manual review (unknown dispatcher: hy3:movewindow)
-- hl.bind("Super+Shift + h", hl.dsp.hy3:movewindow("l"))

-- [hidden]

-- TODO: manual review (unknown dispatcher: hy3:movewindow)
-- hl.bind("Super+Shift + l", hl.dsp.hy3:movewindow("r"))

-- [hidden]

-- TODO: manual review (unknown dispatcher: hy3:movewindow)
-- hl.bind("Super+Shift + k", hl.dsp.hy3:movewindow("u"))

-- [hidden]

-- TODO: manual review (unknown dispatcher: hy3:movewindow)
-- hl.bind("Super+Shift + j", hl.dsp.hy3:movewindow("d"))

-- [hidden]

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER + left", hl.dsp.hy3:movefocus("l"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER + right", hl.dsp.hy3:movefocus("r"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER + up", hl.dsp.hy3:movefocus("u"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER + down", hl.dsp.hy3:movefocus("d"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER + H", hl.dsp.hy3:movefocus("l"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER + L", hl.dsp.hy3:movefocus("r"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER + K", hl.dsp.hy3:movefocus("u"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER + J", hl.dsp.hy3:movefocus("d"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER+ALT + left", hl.dsp.hy3:movefocus("l", "visible"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER+ALT + right", hl.dsp.hy3:movefocus("r", "visible"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER+ALT + up", hl.dsp.hy3:movefocus("u", "visible"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER+ALT + down", hl.dsp.hy3:movefocus("d", "visible"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER+ALT + H", hl.dsp.hy3:movefocus("l", "visible"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER+ALT + L", hl.dsp.hy3:movefocus("r", "visible"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER+ALT + K", hl.dsp.hy3:movefocus("u", "visible"))

-- TODO: manual review (unknown dispatcher: hy3:movefocus)
-- hl.bind("SUPER+ALT + J", hl.dsp.hy3:movefocus("d", "visible"))

-- TODO: manual review (unknown dispatcher: hy3:makegroup)
-- hl.bind("SUPER + v", hl.dsp.hy3:makegroup("v"))

-- TODO: manual review (unknown dispatcher: hy3:makegroup)
-- hl.bind("SUPER + b", hl.dsp.hy3:makegroup("h"))

-- TODO: manual review (unknown dispatcher: hy3:makegroup)
-- hl.bind("CTRL+SUPER + w", hl.dsp.hy3:makegroup("tab"))

-- TODO: manual review (unknown dispatcher: hy3:changegroup)
-- hl.bind("SUPER + w", hl.dsp.hy3:changegroup("toggletab"))

-- TODO: manual review (unknown dispatcher: hy3:setephemeral)
-- hl.bind("SUPER + a", hl.dsp.hy3:setephemeral(true))

-- TODO: manual review (unknown dispatcher: hy3:expand)
-- hl.bind("SUPER + e", hl.dsp.hy3:expand("expand"))

-- TODO: manual review (unknown dispatcher: hy3:expand)
-- hl.bind("SUPER + u", hl.dsp.hy3:expand("base"))

-- TODO: manual review (unknown dispatcher: hy3:focustab)
-- hl.bind("SUPER + Tab", hl.dsp.hy3:focustab("r", "wrap"))

-- TODO: manual review (unknown dispatcher: hy3:focustab)
-- hl.bind("SUPER+SHIFT + Tab", hl.dsp.hy3:focustab("l", "wrap"))

-- TODO: manual review (unknown dispatcher: hy3:locktab)
-- hl.bind("SUPER + grave", hl.dsp.hy3:locktab("lock"))

-- TODO: manual review (unknown dispatcher: hy3:locktab)
-- hl.bind("SUPER+SHIFT + grave", hl.dsp.hy3:locktab("unlock"))
...
-- # bind = $mainMod, Shift, h, hyprtasking:move, left

-- # bind = $mainMod, Shift, j, hyprtasking:move, down

-- # bind = $mainMod, Shift,k, hyprtasking:move, up

-- # bind = $mainMod, Shift,l, hyprtasking:move, right

...
case $desktop in
    ...
    MONITOR=eDP-1 polybar --reload mainbar-i3 -c /home/mattia/.config/polybar/config-eDP1 &
    MONITOR=HDMI-1 polybar --reload mainbar-i3 -c /home/mattia/.config/polybar/config-HDMI &
      #for m in $(xrandr --query | grep " connected" | cut -d" " -f1); do
        #MONITOR=eDP1 polybar --reload mainbar-i3 -c /home/mattia/.config/polybar/config-eDP1 &
        #MONITOR=HDMI1 polybar --reload mainbar-i3 -c /home/mattia/.config/polybar/config-HDMI &
      #done
    else
    ...
    if type "xrandr" > /dev/null; then
      ...
      # done
    MONITOR=eDP-1 polybar --reload mainbar-herbstluftwm -c /home/mattia/.config/polybar/herb-eDP1 &
    MONITOR=HDMI-1 polybar --reload mainbar-herbstluftwm -c /home/mattia/.config/polybar/herb-HDMI &
    else

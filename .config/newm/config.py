...
background = {
    'path': '/home/mattia/.dotfiles/.config/hypr/wallpapers/0000papers.co-am23-tycho-art-cover-music-minimal-art-white-bw-36-3840x2400-4k-wallpaper.jpg',
    'anim': True
}

outputs = [
    { 'name': 'eDP-1' },
    { 'name': 'HDMI-A-1', 'pos_x': -1920, 'pos_y': 0, 'width': 2560, 'height': 1440 }
]
